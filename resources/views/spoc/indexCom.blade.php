              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @forelse ($bcusers as $bcuser)
                    ...
                    <td ><a href="{{ route('tech.edit', $bcuser->id) }}">{{ $bcuser->issue }}</a></td>
                    <td >{{ $bcuser->attend_by }}</td>
                    <td >{{ $bcuser->call_status }}</td>
                    <td ><span><b>Remark:-</b></span>{{ $bcuser->remark }}<br><a class="tmt" style="color:darkgray; font-size: 14px;"><span><b>Close Call:-</b></span>{{ $bcuser->call_close }}</a></td>
                    </tr>
                  @empty
