...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="col-4">
          <h3 class="card-title" style="text-align: center;"><b style="color:#e58c4d;">Ticket No:</b>{{ $bcuser->ticket_no }}<br><br></h3>
        </div>
      <div class="col-md-10">
        ...
        <div class="row">
          <div class="form-inline col-sm-7">
            <form action="{{ route('tech.save', $bcuser->id) }}" method="post" enctype="multipart/form-data"><br>
              @csrf
