        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('tech.dash') }}">Home</a></li>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                    <td >{{ $loop->index + 1 }}</td>
                    <td ><a href="{{ route('tech.view', $bcuser->id) }}">{{ $bcuser->bc_name }}</a></td>
                    <td >{{ $bcuser->phone }}</td>
                    ...
                    <!--  <td>
                      <a href="{{ route('tech.edit', $bcuser->id) }}" class="btn btn-sm btn-outline-danger py-0">Edit</a>
                      <a href="{{ route('tech.view', $bcuser->id) }}" class="btn btn-sm btn-outline-success py-0">View</a>
                    </td> -->
                    </tr>
                    @empty
