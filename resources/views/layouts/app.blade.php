...
<meta property="og:title" content="crm:Customer Relationship Management">
<meta property="og:description" content="crm:Customer Relationship Management">
<meta property="og:image" content="social-image.png">
<meta name="format-detection" content="telephone=no">
<!-- PAGE TITLE HERE -->
<title>DAYLOGS- Customer Relationship Management</title>
<!-- FAVICONS ICON -->
<link rel="shortcut icon" type="image/png" href="images/ffavicon.png">
...
<body data-typography="poppins" data-theme-version="light" data-layout="vertical" data-nav-headerbg="black" data-headerbg="color_1">
    ...
    <div id="main-wrapper">
        ...
        <div class="nav-header">
            <a href="{{ route ('superadmin.list') }}" class="brand-logo">
            	<img src="{{ url('images/white_b1.png') }}" alt="UPICON Logo" class="brand-image elevation-3" style="opacity: 20.2">
		...
		<div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
					<li class="menu-title">DAYLOGS</li>
				...
				<form action="{{ route('admin.save') }}" method="post" enctype="multipart/form-data">
					...
					<div class="row">
						<div class="col-xl-6 mb-3">
							<label for="exampleFormControlInput1" class="form-label">Role ID <span class="text-danger">*</span></label>
							<input type="number" class="form-control" name="role" id="exampleFormControlInput1" placeholder="">
						</div>	
						<div class="col-xl-6 mb-3">
							<label for="exampleFormControlInput2" class="form-label">Applicant Name<span class="text-danger">*</span></label>
							<input type="text" class="form-control" name="name" id="exampleFormControlInput2" placeholder="">
						</div>	
						<div class="col-xl-6 mb-3">
							<label for="exampleFormControlInput3" class="form-label">Applicant Email<span class="text-danger">*</span></label>
							<input type="email" class="form-control" name="email" id="exampleFormControlInput3" placeholder="">
						</div>
						<div class="col-xl-6 mb-3">
							<label for="exampleFormControlInput4" class="form-label">Password<span class="text-danger">*</span></label>
							<input type="password" class="form-control" name="password" id="exampleFormControlInput4" placeholder="">
						</div>
						<!-- <div class="col-xl-6 mb-3">
							<label class="form-label">Designation<span class="text-danger">*</span></label>
							<select class="default-select style-1 form-control" name="designation" id="designation">
						...
						<div class="col-xl-6 mb-3">
							...
							<select class="default-select style-1 form-control" name="dept_id" id="dept_id">
								<option  data-display="Select">Please select</option>
						...
						<!-- <div class="col-xl-6 mb-3">
							...
							<input type="number" class="form-control" name="mobile" id="exampleFormControlInput88" placeholder="">
						</div> -->
						<!-- <div class="col-xl-6 mb-3">
        ...
        <div class="footer">
          <div class="copyright">
            <p>Copyright © Developed by <a href="https://upicon.in/" target="_blank">UPICON</a> 2024</p>
          </div>
        </div>
	</div>
