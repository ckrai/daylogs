...
<head>
	...
	<!-- FAVICONS ICON -->
	<link rel="shortcut icon" type="image/png" href="images/favicon123.png">
				...
				<div class="col-lg-6 col-md-12 col-sm-12 mx-auto align-self-center">
					<div class="login-form">
						<div class="text-center">
							...
							<p>Sign in to your account to start using DAYLOGS</p>
						</div>
						<form method="POST" action="{{ route('login') }}">
							@csrf
							<div class="mb-4">
								<label class="mb-1 text-dark">Email</label>
								<input type="email" id="email" name="email" class="form-control form-control" value="hello@example.com">
							</div>
                ...
                <div class="col-xl-6 col-lg-6">
					<div class="pages-left h-100">
						<div class="login-content">
							<a href="#"><img src="images/black_b1.png" class="mb-3 logo-dark" alt=""></a>
							<a href="#"><img src="images/white_b1.png" class="mb-3 logo-light" alt=""></a>
