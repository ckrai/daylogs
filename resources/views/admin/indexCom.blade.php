          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  @forelse ($attendances as $bcuser)
                  <tr>
                    <td >{{ $loop->index + 1 }}</td>
                    <td ><a href="{{ route('upicon.edit', $bcuser->id) }}">{{ $bcuser->u_name }}</a></td>
                    <td >{{ $bcuser->checkin_date }}</td>
                    <td >{{ $bcuser->checkin_time }}</td>
                    <td >{{ $bcuser->checkout_time }}</td>
                    <td >{{ $bcuser->status }}</td>
