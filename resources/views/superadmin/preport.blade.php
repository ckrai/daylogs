...
<div class="container">
    ...
    <table id="example1" class="table table-bordered table-hover">
        ...
        <tr class="text-center">
         ...
         <th class="text-center"><span id="bc_target_ac_opening">{{$bc_target->ac_opening}}</span></th>
         <th class="text-center"><span id="performance_ac_opening"> {{$performance->ac_opening}}</span></th>
         <th class="text-center"><span id="nor_score_ac_opening">20</span></th>
         <th class="text-center"><span id="score_ac_opening">20</span></th>
         <td class="text-center"><b>Total score:-</b><span id="score"></span></td>
        </tr>
        <tr class="text-center">
         ...
         <input type="number" class="form-control" id="bc_target_fund_transfer" min="0" name="" value="{{$bc_target->fund_transfer}}"></th>
         <th class="text-center" ><span id="bc_target_fund_transfer">{{$bc_target->fund_transfer}}</span></th>
         <th class="text-center" ><span id="performance_fund_transfer"> {{$performance->fund_transfer}}</span></th>
         <th class="text-center"><span id="nor_score_fund_transfer">20</span></th>
         <th class="text-center"><span id="score_fund_transfer">20</span></th>
         <td class="text-center"><b>Grade:-</b><span id="grade"></span></td>
        </tr>
        <tr class="text-center">
         <td class="text-center">3</td>
         <th class="text-center">Total Transaction
         ...
         <input type="number" class="form-control" id="bc_target_total_tran" min="0" name="" value="{{$bc_target->total_tran}}"></th>
         <th class="text-center"><span id="bc_target_total_tran">{{$bc_target->total_tran}}</span></th>
         <th class="text-center"><span id="performance_total_tran"> {{$performance->total_tran}}</span></th>
         <th class="text-center"><span id="nor_score_total_tran">20</span></th>
         <th class="text-center"><span id="score_total_tran">20</span></th>
         <td class="text-center"><b>Rating:-</b><span id="rating"></span></td>
        </tr>
        <tr class="text-center">
         <td class="text-center">4</td>
         <th class="text-center">RuPay-Txs<input type="number" class="form-control" display="none" min="0" max="1" id="bc_status_rupay_trnx" name="" value="{{$bc_status->rupay_trnx}}"><input type="number" class="form-control" min="0" max="100" id="bc_allocation_rupay_trnx" name="" value="{{$bc_allocation->rupay_trnx}}"><input type="number" class="form-control" id="bc_target_rupay_trnx" min="0" name="" value="{{$bc_target->rupay_trnx}}"></th>
         <th class="text-center"><span id="bc_target_rupay_trnx">{{$bc_target->rupay_trnx}}</span></th>
         <th class="text-center"><span id="performance_rupay_trnx"> {{$performance->rupay_trnx}}</span></th>
         <th class="text-center"><span id="nor_score_rupay_trnx">20</span></th>
         <th class="text-center"><span id="score_rupay_trnx">20</span></th>
        </tr>
        <tr class="text-center">
         ...
         <th class="text-center"><span id="bc_target_mobile_seed">{{$bc_target->mobile_seed}}</span></th>
         <th class="text-center"><span id="performance_mobile_seed"> {{$performance->mobile_seed}}</span></th>
         <th class="text-center"><span id="nor_score_mobile_seed">20</span></th>
         <th class="text-center"><span id="score_mobile_seed">20</span></th>
        </tr>
        <tr class="text-center">
         <td class="text-center">6</td>
         <th class="text-center">BBPS<input type="number" class="form-control" display="none" min="0" max="1" id="bc_status_bbps" name="" value="{{$bc_status->bbps}}"><input type="number" class="form-control" min="0" max="100" id="bc_allocation_bbps" name="" value="{{$bc_allocation->bbps}}"><input type="number" class="form-control" id="bc_target_bbps" min="0" name="" value="{{$bc_target->bbps}}"></th>
         <th class="text-center"><span id="bc_target_bbps">{{$bc_target->bbps}}</span></th>
         <th class="text-center"><span id="performance_bbps"> {{$performance->bbps}}</span></th>
         <th class="text-center"><span id="nor_score_bbps">20</span></th>
         <th class="text-center"><span id="score_bbps">20</span></th>
        </tr>
        <tr class="text-center">
         <td class="text-center">7</td>
         <th class="text-center">RD/FD<input type="number" class="form-control" display="none" min="0" max="1" id="bc_status_rd_fd" name="" value="{{$bc_status->rd_fd}}"><input type="number" class="form-control" min="0" max="100" id="bc_allocation_rd_fd" name="" value="{{$bc_allocation->rd_fd}}"><input type="number" class="form-control" id="bc_target_rd_fd" min="0" name="" value="{{$bc_target->rd_fd}}"></th>
         <th class="text-center"><span id="bc_target_rd_fd">{{$bc_target->rd_fd}}</span></th>
         <th class="text-center"><span id="performance_rd_fd"> {{$performance->rd_fd}}</span></th>
         <th class="text-center"><span id="nor_score_rd_fd">20</span></th>
         <th class="text-center"><span id="score_rd_fd">20</span></th>
        </tr>
        <tr class="text-center">
         <td class="text-center">8</td>
         <th class="text-center">PMJJBY<input type="number" class="form-control" display="none" min="0" max="1" id="bc_status_pmjby" name="" value="{{$bc_status->pmjby}}"><input type="number" class="form-control" min="0" max="100" id="bc_allocation_pmjby" name="" value="{{$bc_allocation->pmjby}}"><input type="number" class="form-control" id="bc_target_pmjby" min="0" name="" value="{{$bc_target->pmjby}}"></th>
         <th class="text-center"><span id="bc_target_pmjby">{{$bc_target->pmjby}}</span></th>
         <th class="text-center"><span id="performance_pmjby"> {{$performance->pmjby}}</span></th>
         <th class="text-center"><span id="nor_score_pmjby">20</span></th>
         <th class="text-center"><span id="score_pmjby">20</span></th>
        </tr>
        <tr class="text-center">
         <td class="text-center">9</td>
         <th class="text-center">PMSBY<input type="number" class="form-control" display="none" min="0" max="1" id="bc_status_pmsby" name="" value="{{$bc_status->pmsby}}"><input type="number" class="form-control" min="0" max="100" id="bc_allocation_pmsby" name="" value="{{$bc_allocation->pmsby}}"><input type="number" class="form-control" id="bc_target_pmsby" min="0" name="" value="{{$bc_target->pmsby}}"></th>
         <th class="text-center"><span id="bc_target_pmsby">{{$bc_target->pmsby}}</span></th>
         <th class="text-center"><span id="performance_pmsby"> {{$performance->pmsby}}</span></th>
         <th class="text-center"><span id="nor_score_pmsby">20</span></th>
         <th class="text-center"><span id="score_pmsby">20</span></th>
        </tr>
        <tr class="text-center">
         <td class="text-center">10</td>
         <th class="text-center">APY<input type="number" class="form-control" display="none" min="0" max="1" id="bc_status_apy" name="" value="{{$bc_status->apy}}"><input type="number" class="form-control" min="0" max="100" id="bc_allocation_apy" name="" value="{{$bc_allocation->apy}}"><input type="number" class="form-control" id="bc_target_apy" min="0" name="" value="{{$bc_target->apy}}"></th>
        <th class="text-center"><span id="bc_target_apy">{{$bc_target->apy}}</span></th>
         <th class="text-center"><span id="performance_apy"> {{$performance->apy}}</span></th>
         <th class="text-center"><span id="nor_score_apy">20</span></th>
         <th class="text-center"><span id="score_apy">20</span></th>
      <!--  <th class="text-center"><span id="total_score_apy">43.2</span></th>
         <th class="text-center"><span id="grade_apy">A</span></th> -->
        </tr>
