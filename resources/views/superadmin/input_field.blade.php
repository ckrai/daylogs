...
<div class="container">
    <div class="row justify-content-center">
        ...
        <h5 class="text-center">NAME:- {{$performance->bc_name}}</h5>
        ...
        <tr class="tag_sec">
         ...
         <th class="text-center">Normalized Score(%)</th>
         <th class="text-center">Score(%)</th>
         <th class="text-center">Total Score/Grade</th> -->
         </tr>
        </thead>
        <tbody>
        <tr class="text-center">
         ...
         <span id="performance_ac_opening">{{$performance->ac_opening}}</span>
         <span id="nor_score_ac_opening" display="none">20</span>
         <span id="score_ac_opening" display="none">20</span>
         <span id="score" display="none">20</span> <br><span id="grade" display="none">20</span> <br><span id="rating">20</span>
         </th>
         <th class="text-center fill"><input class="form-control" type="number" min="0" max="1" id="bc_status_ac_opening" name="" value="{{$bc_status->ac_opening}}"></th>
         <th class="text-center fill"><input  class="form-control" type="number" min="0" max="100" id="bc_allocation_ac_opening" name="" value="{{$bc_allocation->ac_opening}}"></th>
         <th class="text-center"><input type="number" class="form-control" id="bc_target_ac_opening" min="0" name="" value="{{$bc_target->ac_opening}}"></th>
         <!-- <th class="text-center" ></th>
         <th class="text-center"></th>
         <th class="text-center"></th>
         <th class="text-center"> <br></th> -->
         <!-- <th class="text-center"><span id="total_score_ac_funded">43.2</span></th>
         <th class="text-center"><span id="grade_ac_funded">A</span></th> -->
        </tr>
        <tr class="text-center">
         <td class="text-center">2</td>
         <th class="text-center">Fund Transfer
            <span id="performance_fund_transfer" display="none">{{$performance->fund_transfer}}</span>
            <span id="nor_score_fund_transfer" display="none">20</span>
            <span id="score_fund_transfer" display="none">20</span>
         </th>
         <th class="text-center"><input type="number" class="form-control" min="0" max="1" id="bc_status_fund_transfer" name="" value="{{$bc_status->fund_transfer}}"></th>
         <th class="text-center"><input type="number" class="form-control" min="0" max="100" id="bc_allocation_fund_transfer" name="" value="{{$bc_allocation->fund_transfer}}"></th>
         <th class="text-center"><input type="number" class="form-control" id="bc_target_fund_transfer" min="0" name="" value="{{$bc_target->fund_transfer}}"></th>
        <!--  <th class="text-center" ></th>
         <th class="text-center"></th>
         <th class="text-center"></th> -->
        </tr>
        <tr class="text-center">
         ...
         <th class="text-center">Total Txs
            <span id="performance_total_tran" display="none">{{$performance->total_tran}}</span>
            <span id="nor_score_total_tran" display="none">20</span>
            <span id="score_total_tran" display="none">20</span>
        </th>
         <th class="text-center"><input type="number" class="form-control" min="0" max="1" id="bc_status_total_tran" name="" value="{{$bc_status->total_tran}}"></th>
         <th class="text-center"><input type="number" class="form-control" min="0" max="100" id="bc_allocation_total_tran" name="" value="{{$bc_allocation->total_tran}}"></th>
         <th class="text-center"><input type="number" class="form-control" id="bc_target_total_tran" min="0" name="" value="{{$bc_target->total_tran}}"></th>
         <!-- <th class="text-center"></th>
         <th class="text-center"></th>
         <th class="text-center"></th> -->
        </tr>
        <tr class="text-center">
         ...
         <th class="text-center">RuPay-Txs
            <span id="performance_rupay_trnx">{{$performance->rupay_trnx}}</span>
            <span id="nor_score_rupay_trnx">20</span>
            <span id="score_rupay_trnx">20</span>
        </th>
         <th class="text-center"><input type="number" class="form-control" min="0" max="1" id="bc_status_rupay_trnx" name="" value="{{$bc_status->rupay_trnx}}"></th>
         <th class="text-center"><input type="number" class="form-control" min="0" max="100" id="bc_allocation_rupay_trnx" name="" value="{{$bc_allocation->rupay_trnx}}"></th>
         <th class="text-center"><input type="number" class="form-control" id="bc_target_rupay_trnx" min="0" name="" value="{{$bc_target->rupay_trnx}}"></th>
         <!-- <th class="text-center"></th>
         <th class="text-center"></th>
         <th class="text-center"></th> -->
        </tr>
        <tr class="text-center">
         ...
         <th class="text-center">Mobile Seeding
            <span id="performance_rupay_trnx">{{$performance->mobile_seed}}</span>
            <span id="nor_score_rupay_trnx">20</span>
            <span id="score_rupay_trnx">20</span>
        </th>
         <th class="text-center"><input type="number" class="form-control" min="0" max="1" id="bc_status_mobile_seed" name="" value="{{$bc_status->mobile_seed}}"></th>
         <th class="text-center"><input type="number" class="form-control" min="0" max="100" id="bc_allocation_mobile_seed" name="" value="{{$bc_allocation->mobile_seed}}"></th>
         <th class="text-center"><input type="number" class="form-control" id="bc_target_mobile_seed" min="0" name="" value="{{$bc_target->mobile_seed}}"></th>
         <!-- <th class="text-center"></th>
         <th class="text-center"></th>
         <th class="text-center"></th> -->
        </tr>
        <tr class="text-center">
         ...
         <th class="text-center">BBPS
            <span id="performance_bbps">{{$performance->bbps}}</span>
            <span id="nor_score_bbps">20</span>
            <span id="score_bbps">20</span>
        </th>
         <th class="text-center"><input type="number" class="form-control" min="0" max="1" id="bc_status_bbps" name="" value="{{$bc_status->bbps}}"></th>
         <th class="text-center"><input type="number" class="form-control" min="0" max="100" id="bc_allocation_bbps" name="" value="{{$bc_allocation->bbps}}"></th>
         <th class="text-center"><input type="number" class="form-control" id="bc_target_bbps" min="0" name="" value="{{$bc_target->bbps}}"></th>
         <!-- <th class="text-center"></th>
         <th class="text-center"></th>
         <th class="text-center"></th> -->
        </tr>
        <tr class="text-center">
         ...
         <th class="text-center">RD/FD
            <span id="performance_rd_fd">{{$performance->rd_fd}}</span>
            <span id="nor_score_rd_fd">20</span>
            <span id="score_rd_fd">20</span>
        </th>
         <th class="text-center"><input type="number" class="form-control" min="0" max="1" id="bc_status_rd_fd" name="" value="{{$bc_status->rd_fd}}"></th>
         <th class="text-center"><input type="number" class="form-control" min="0" max="100" id="bc_allocation_rd_fd" name="" value="{{$bc_allocation->rd_fd}}"></th>
         <th class="text-center"><input type="number" class="form-control" id="bc_target_rd_fd" min="0" name="" value="{{$bc_target->rd_fd}}"></th>
         <!-- <th class="text-center"></th>
         <th class="text-center"></th>
         <th class="text-center"></th> -->
        </tr>
        <tr class="text-center">
         ...
         <th class="text-center">PMJJBY
            <span id="performance_pmjby">{{$performance->pmjby}}</span>
            <span id="nor_score_pmjby">20</span>
            <span id="score_pmjby">20</span>
         </th>
         <th class="text-center"><input type="number" class="form-control" min="0" max="1" id="bc_status_pmjby" name="" value="{{$bc_status->pmjby}}"></th>
         <th class="text-center"><input type="number" class="form-control" min="0" max="100" id="bc_allocation_pmjby" name="" value="{{$bc_allocation->pmjby}}"></th>
         <th class="text-center"><input type="number" class="form-control" id="bc_target_pmjby" min="0" name="" value="{{$bc_target->pmjby}}"></th>
         <!-- <th class="text-center"></th>
         <th class="text-center"></th>
         <th class="text-center"></th> -->
        </tr>
        <tr class="text-center">
         ...
         <th class="text-center">PMSBY
            <span id="performance_pmsby">{{$performance->pmsby}}</span>
            <span id="nor_score_pmsby">20</span>
            <span id="score_pmsby">20</span></th>
         <th class="text-center"><input type="number" class="form-control" min="0" max="1" id="bc_status_pmsby" name="" value="{{$bc_status->pmsby}}"></th>
         <th class="text-center"><input type="number" class="form-control" min="0" max="100" id="bc_allocation_pmsby" name="" value="{{$bc_allocation->pmsby}}"></th>
         <th class="text-center"><input type="number" class="form-control" id="bc_target_pmsby" min="0" name="" value="{{$bc_target->pmsby}}"></th>
         <!-- <th class="text-center"></th>
         <th class="text-center"></th>
         <th class="text-center"></th> -->
        </tr>
        <tr class="text-center">
         ...
         <th class="text-center">APY
            <span id="performance_apy">{{$performance->apy}}</span>
            <span id="nor_score_apy">20</span>
            <span id="score_apy">20</span>
         </th>
         <th class="text-center"><input type="number" class="form-control" min="0" max="1" id="bc_status_apy" name="" value="{{$bc_status->apy}}"></th>
         <th class="text-center"><input type="number" class="form-control" min="0" max="100" id="bc_allocation_apy" name="" value="{{$bc_allocation->apy}}"></th>
         <th class="text-center"><input type="number" class="form-control" id="bc_target_apy" min="0" name="" value="{{$bc_target->apy}}"></th>
         <!-- <th class="text-center"></th>
         <th class="text-center"></th>
         <th class="text-center"></th> -->
        </tr>
